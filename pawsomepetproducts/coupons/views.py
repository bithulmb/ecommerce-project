...
from .forms import AddCouponForm, ApplyCouponForm
    ...
    if form.is_valid():
        ...
        try:
            ...
            if grand_total >= coupon.minimum_order_amount:
                ...
                discount = round(
                    grand_total * coupon.discount_percent / 100, 2
                )  # calculating the discount and rounding off the decimal value to 2 points.
                ...
                messages.error(
                    request,
                    f"Coupon is only valid for orders above ₹ {coupon.minimum_order_amount} ",
                )
                context["form"] = form
                return redirect(url)
